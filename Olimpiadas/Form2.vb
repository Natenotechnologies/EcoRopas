Public Class Form2
    Public Property BotellaAF2 As Integer
    ...
    Private Sub Button16_Click(sender As Object, e As EventArgs) Handles Button16.Click
        BotellaAF2 = NumericUpDown1.Value + NumericUpDown10.Value + NumericUpDown15.Value + NumericUpDown20.Value + NumericUpDown25.Value + NumericUpDown30.Value + NumericUpDown35.Value + NumericUpDown40.Value + NumericUpDown45.Value + NumericUpDown50.Value + NumericUpDown55.Value + NumericUpDown60.Value
